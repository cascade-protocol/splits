...
export const ERROR_MESSAGES: Record<CascadeSplitsError, string> = {
	[CascadeSplitsError.InvalidRecipientCount]:
		"Recipient count must be between 1 and 20",
	[CascadeSplitsError.InvalidSplitTotal]:
		"Recipient percentages must sum to 9900 bps (99%)",
	...
	[CascadeSplitsError.InsufficientRemainingAccounts]:
	...
	[CascadeSplitsError.InvalidProtocolFeeRecipient]:
